...
extern "C" {
  ...
  void __attribute__ ((interrupt("IRQ"))) TIM1_UP_TIM16_IRQHandler() {
...
#if defined(USE_TIM1_BRK_TIM15_INTERRUPT)

  void __attribute__ ((interrupt("IRQ"))) TIM1_BRK_TIM15_IRQHandler() {
...
#if defined(USE_TIM1_TRG_COM_TIM17_INTERRUPT)

  void __attribute__ ((interrupt("IRQ"))) TIM1_TRG_COM_TIM17_IRQHandler() {
