...
extern "C" {
    ...
    void __attribute__ ((interrupt("IRQ"))) I2C1_IRQHandler(void) {
      ...
      if(I2C_GetITStatus(I2C1,I2C_IT_TXI)!=RESET) {
      ...
      else if(I2C_GetITStatus(I2C1,I2C_IT_RXI)!=RESET) {
      ...
      else if(I2C_GetITStatus(I2C1,I2C_IT_STOPI)!=RESET) {
      ...
      else if(I2C_GetITStatus(I2C1,I2C_IT_ADDRI)!=RESET) {
      ...
      else if(I2C_GetITStatus(I2C1,I2C_IT_TCI)!=RESET) {
        I2CInterruptFeature<1>::_i2cInstance->I2CInterruptEventSender.raiseEvent(I2CEventType::EVENT_TRANSFER_COMPLETE);
        I2C_ClearITPendingBit(I2C1,I2C_IT_TCI);
      }
      else if(I2C_GetITStatus(I2C1,I2C_IT_ERRI)!=RESET) {
        I2CInterruptFeature<1>::_i2cInstance->I2CInterruptEventSender.raiseEvent(I2CEventType::EVENT_ERROR);
        I2C_ClearITPendingBit(I2C1,I2C_IT_ERRI);
      }
      else if(I2C_GetITStatus(I2C1,I2C_IT_NACKI)!=RESET) {
