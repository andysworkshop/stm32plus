    ...
    public:
      static void initialise() {
        ...
        GpioPinInitialiser::initialise(
          ...
          Gpio::PUPD_NONE,
          Gpio::PUSH_PULL,
          GpioAlternateFunctionMapper<PERIPHERAL_FSMC,GPIOD_BASE,GPIO_Pin_7>::GPIO_AF);
      }
    ...
    public:
      static void initialise() {
        ...
        GpioPinInitialiser::initialise(
          ...
          Gpio::PUPD_NONE,
          Gpio::PUSH_PULL,
          GpioAlternateFunctionMapper<PERIPHERAL_FSMC,GPIOG_BASE,GPIO_Pin_9>::GPIO_AF);
      }
    ...
    public:
      static void initialise() {
        ...
        GpioPinInitialiser::initialise(
          ...
          Gpio::PUPD_NONE,
          Gpio::PUSH_PULL,
          GpioAlternateFunctionMapper<PERIPHERAL_FSMC,GPIOG_BASE,GPIO_Pin_10>::GPIO_AF);
      }
    ...
    public:
      static void initialise() {
        ...
        GpioPinInitialiser::initialise(
          ...
          Gpio::PUPD_NONE,
          Gpio::PUSH_PULL,
          GpioAlternateFunctionMapper<PERIPHERAL_FSMC,GPIOG_BASE,GPIO_Pin_12>::GPIO_AF);
      }
