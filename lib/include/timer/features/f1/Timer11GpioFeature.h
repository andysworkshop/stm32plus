...
namespace stm32plus {
  ...
  struct TIM11_CH1_IN {
    ...
    TIM11_CH1_IN() {
      ...
      GpioPinInitialiser::initialise(ports[TRemapLevel],pins[TRemapLevel],Gpio::INPUT,(GPIOSpeed_TypeDef)PeripheralTraits<PERIPHERAL_TIMER11>::GPIO_SPEED,Gpio::PUPD_NONE); 
    }
  };
