...
namespace stm32plus {
  ...
  struct TIM9_CH1_IN {
    ...
    TIM9_CH1_IN() {
      ...
      static constexpr GPIO_TypeDef *const ports[4]={ GPIOA,nullptr,nullptr,GPIOE };
      static constexpr const uint16_t pins[4]={ GPIO_Pin_2,0,0,GPIO_Pin_5 };

      GpioPinInitialiser::initialise(ports[TRemapLevel],pins[TRemapLevel],Gpio::INPUT,(GPIOSpeed_TypeDef)PeripheralTraits<PERIPHERAL_TIMER9>::GPIO_SPEED,Gpio::PUPD_NONE); 
    }
  };
