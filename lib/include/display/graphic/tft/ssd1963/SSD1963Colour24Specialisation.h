...
namespace stm32plus {
  namespace display {
    ...
    /**
     * Template class holding the specialisation of SSD1963Colour for 24-bit colours
     * @tparam TAccessMode The access mode class (e.g. FSMC)
     * @tparam TPanelTraits Unique identifying data about this panel
     */

    template<class TAccessMode,class TPanelTraits>
    class SSD1963Colour<COLOURS_24BIT,TAccessMode,TPanelTraits> {
    ...
    template<class TAccessMode,class TPanelTraits>
    inline SSD1963Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::SSD1963Colour(TAccessMode& accessMode)
      : _accessMode(accessMode) {
    }


    /**
     * Get the register setting for 24 bit colours
     * @return 0x20 is the right setting
     */

    template<class TAccessMode,class TPanelTraits>
    constexpr inline uint8_t SSD1963Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::getLcdModeBits() const {
      return 0x20;      // 24 bit
    }


    /**
     * Unpack the colour from rrggbb to the internal 12 bit x2 format
    ...
    template<class TAccessMode,class TPanelTraits>
    inline void SSD1963Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::unpackColour(tCOLOUR src,UnpackedColour& dest) const {
    ...
    template<class TAccessMode,class TPanelTraits>
    inline void SSD1963Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::unpackColour(uint8_t red,uint8_t green,uint8_t blue,UnpackedColour& dest) const {
    ...
    template<class TAccessMode,class TPanelTraits>
    inline void SSD1963Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::fillPixels(uint32_t numPixels,const UnpackedColour& cr) const {
    ...
    template<class TAccessMode,class TPanelTraits>
    inline void SSD1963Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::allocatePixelBuffer(uint32_t numPixels,uint8_t*& buffer,uint32_t& bytesPerPixel) const {
