...
namespace stm32plus {
  namespace display {
    ...
    template<class TAccessMode>
    constexpr inline uint16_t ILI9481Colour<COLOURS_16BIT,TAccessMode>::getPixelFormat() const {
    ...
    template<class TAccessMode>
    inline void ILI9481Colour<COLOURS_16BIT,TAccessMode>::writePixelAgain(const UnpackedColour& cr) const {
