...
namespace stm32plus {
  namespace display {
    ...
    template<class TAccessMode,class TPanelTraits>
    inline HX8352AOrientation<LANDSCAPE,TAccessMode,TPanelTraits>::HX8352AOrientation(TAccessMode& accessMode)
    ...
    template<class TAccessMode,class TPanelTraits>
    constexpr inline int16_t HX8352AOrientation<LANDSCAPE,TAccessMode,TPanelTraits>::getWidth() const {
    ...
    template<class TAccessMode,class TPanelTraits>
    constexpr inline int16_t HX8352AOrientation<LANDSCAPE,TAccessMode,TPanelTraits>::getHeight() const {
    ...
    template<class TAccessMode,class TPanelTraits>
    inline void HX8352AOrientation<LANDSCAPE,TAccessMode,TPanelTraits>::setScrollPosition(int16_t scrollPosition) {
