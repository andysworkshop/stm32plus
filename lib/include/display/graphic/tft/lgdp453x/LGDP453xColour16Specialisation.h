...
namespace stm32plus {
  namespace display {
    ...
    /**
     * Template class holding the specialisation of LGDP453xColour for 16-bit colours
     * @tparam TAccessMode The access mode class (e.g. FSMC)
     */

    template<class TAccessMode>
    class LGDP453xColour<COLOURS_16BIT,TAccessMode> {
    ...
    template<class TAccessMode>
    inline LGDP453xColour<COLOURS_16BIT,TAccessMode>::LGDP453xColour(TAccessMode& accessMode)
    ...
    template<class TAccessMode>
    constexpr inline uint16_t LGDP453xColour<COLOURS_16BIT,TAccessMode>::getColourEntryMode() const {
      return 0;
    }
    ...
    template<class TAccessMode>
    inline void LGDP453xColour<COLOURS_16BIT,TAccessMode>::unpackColour(tCOLOUR src,UnpackedColour& dest) const {
    ...
    template<class TAccessMode>
    inline void LGDP453xColour<COLOURS_16BIT,TAccessMode>::unpackColour(uint8_t red,uint8_t green,uint8_t blue,UnpackedColour& dest) const {
    ...
    template<class TAccessMode>
    inline void LGDP453xColour<COLOURS_16BIT,TAccessMode>::allocatePixelBuffer(uint32_t numPixels,uint8_t*& buffer,uint32_t& bytesPerPixel) const {
