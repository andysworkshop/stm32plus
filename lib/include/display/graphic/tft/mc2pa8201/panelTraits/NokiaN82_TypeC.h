...
namespace stm32plus {
  namespace display {
    ...
    constexpr inline uint16_t NokiaN82_TypeC::getScrollHeight() {
      return 320;
    }
    ...
    template<>
    constexpr inline uint8_t NokiaN82_TypeC::getMemoryAccessControlCommand<LANDSCAPE>() {
      return 0xa0;
    }
    ...
    template<>
    constexpr inline uint8_t NokiaN82_TypeC::getMemoryAccessControlCommand<PORTRAIT>() {
      return 0xc0;
    }
  }
}
