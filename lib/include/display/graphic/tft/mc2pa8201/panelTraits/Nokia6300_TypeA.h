...
namespace stm32plus {
  namespace display {
    ...
    constexpr inline uint16_t Nokia6300_TypeA::getScrollHeight() {
      return 320;
    }
    ...
    template<>
    constexpr inline uint8_t Nokia6300_TypeA::getColumnAddressCommand<LANDSCAPE>() {
      return mc2pa8201::COLUMN_ADDRESS_SET;
    }
    ...
    template<>
    constexpr inline uint8_t Nokia6300_TypeA::getPageAddressCommand<LANDSCAPE>() {
      return mc2pa8201::PAGE_ADDRESS_SET;
    }
    ...
    template<>
    constexpr inline uint8_t Nokia6300_TypeA::getMemoryAccessControlCommand<LANDSCAPE>() {
      return 0xa0;
    }
    ...
    template<>
    constexpr inline uint8_t Nokia6300_TypeA::getMemoryAccessControlCommand<PORTRAIT>() {
      return 0xc0;
    }
  }
}
