...
namespace stm32plus {
  namespace display {
    ...
    constexpr inline uint16_t Nokia6300_TypeB::getScrollHeight() {
      return 320;
    }
    ...
    constexpr inline int16_t Nokia6300_TypeB::normaliseScrollPosition(int16_t scrollPosition) {
    ...
    template<>
    constexpr inline uint8_t Nokia6300_TypeB::getColumnAddressCommand<LANDSCAPE>() {
      return mc2pa8201::COLUMN_ADDRESS_SET;
    }
    ...
    template<>
    constexpr inline uint8_t Nokia6300_TypeB::getPageAddressCommand<LANDSCAPE>() {
      return mc2pa8201::PAGE_ADDRESS_SET;
    }
    ...
    template<>
    constexpr inline uint8_t Nokia6300_TypeB::getMemoryAccessControlCommand<LANDSCAPE>() {
      return 0xa0;
    }
    ...
    template<>
    constexpr inline uint8_t Nokia6300_TypeB::getMemoryAccessControlCommand<PORTRAIT>() {
      return 0xc0;
    }
  }
}
