...
namespace stm32plus {
  namespace display {
    ...
    constexpr inline uint16_t Nokia2730_TypeC::getScrollHeight() {
      return 320;
    }
    ...
    inline int16_t Nokia2730_TypeC::normaliseScrollPosition(int16_t scrollPosition) {
    ...
    template<>
    constexpr inline uint8_t Nokia2730_TypeC::getColumnAddressCommand<LANDSCAPE>() {
      return mc2pa8201::PAGE_ADDRESS_SET;
    }
    ...
    template<>
    constexpr inline uint8_t Nokia2730_TypeC::getPageAddressCommand<LANDSCAPE>() {
      return mc2pa8201::COLUMN_ADDRESS_SET;
    }
    ...
    template<>
    constexpr inline uint8_t Nokia2730_TypeC::getMemoryAccessControlCommand<LANDSCAPE>() {
      return 0xa0;
    }
    ...
    template<>
    constexpr inline uint8_t Nokia2730_TypeC::getMemoryAccessControlCommand<PORTRAIT>() {
      return 0xc0;
    }
  }
}
