...
namespace stm32plus {
  namespace display {
    ...
    template<class TAccessMode,class TPanelTraits>
    inline MC2PA8201Colour<COLOURS_18BIT,TAccessMode,TPanelTraits>::MC2PA8201Colour(TAccessMode& accessMode)
    ...
    template<class TAccessMode,class TPanelTraits>
    constexpr inline uint16_t MC2PA8201Colour<COLOURS_18BIT,TAccessMode,TPanelTraits>::getInterfacePixelFormat() const {
      return 0x66;
    }
    ...
    template<class TAccessMode,class TPanelTraits>
    inline void MC2PA8201Colour<COLOURS_18BIT,TAccessMode,TPanelTraits>::rawTransfer(const void *buffer,uint32_t numPixels) const {
