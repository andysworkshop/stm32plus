...
namespace stm32plus {
  namespace display {
    ...
    /**
     * Template class holding the specialisation of SSD1289Colour for 16-bit colours
     * @tparam TAccessMode The access mode class (e.g. FSMC)
     */

    template<class TAccessMode>
    class SSD1289Colour<COLOURS_16BIT,TAccessMode> {
    ...
    template<class TAccessMode>
    inline SSD1289Colour<COLOURS_16BIT,TAccessMode>::SSD1289Colour(TAccessMode& accessMode)
    ...
    template<class TAccessMode>
    constexpr inline uint16_t SSD1289Colour<COLOURS_16BIT,TAccessMode>::getColourEntryMode() const {
      return 0x6800;
    }
    ...
    template<class TAccessMode>
    inline void SSD1289Colour<COLOURS_16BIT,TAccessMode>::unpackColour(tCOLOUR src,UnpackedColour& dest) const {
    ...
    template<class TAccessMode>
    inline void SSD1289Colour<COLOURS_16BIT,TAccessMode>::unpackColour(uint8_t red,uint8_t green,uint8_t blue,UnpackedColour& dest) const {
    ...
    template<class TAccessMode>
    inline void SSD1289Colour<COLOURS_16BIT,TAccessMode>::writePixel(const UnpackedColour& cr) const {
    ...
    template<class TAccessMode>
    inline void SSD1289Colour<COLOURS_16BIT,TAccessMode>::writePixelAgain(const UnpackedColour& cr) const {
    ...
    template<class TAccessMode>
    inline void SSD1289Colour<COLOURS_16BIT,TAccessMode>::fillPixels(uint32_t numPixels,const UnpackedColour& cr) const {
    ...
    template<class TAccessMode>
    inline void SSD1289Colour<COLOURS_16BIT,TAccessMode>::allocatePixelBuffer(uint32_t numPixels,uint8_t*& buffer,uint32_t& bytesPerPixel) const {
    ...
    template<class TAccessMode>
    inline void SSD1289Colour<COLOURS_16BIT,TAccessMode>::rawTransfer(const void *buffer,uint32_t numPixels) const {
