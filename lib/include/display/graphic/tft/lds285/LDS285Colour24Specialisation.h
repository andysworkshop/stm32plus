...
namespace stm32plus {
  namespace display {
    ...
    template<class TAccessMode,class TPanelTraits>
    inline LDS285Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::LDS285Colour(TAccessMode& accessMode)
    ...
    template<class TAccessMode,class TPanelTraits>
    constexpr inline uint16_t LDS285Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::getInterfacePixelFormat() const {
      return 0x77;
    }
    ...
    template<class TAccessMode,class TPanelTraits>
    inline void LDS285Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::writePixelAgain(const UnpackedColour& cr) const {
      _accessMode.writeData(cr.r);
      _accessMode.writeData(cr.g);
      _accessMode.writeData(cr.b);
    }
    ...
    template<class TAccessMode,class TPanelTraits>
    inline void LDS285Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::rawTransfer(const void *buffer,uint32_t numPixels) const {
