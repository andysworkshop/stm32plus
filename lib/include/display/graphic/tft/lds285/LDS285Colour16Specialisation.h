...
namespace stm32plus {
  namespace display {
    ...
    template<class TAccessMode,class TPanelTraits>
    inline LDS285Colour<COLOURS_16BIT,TAccessMode,TPanelTraits>::LDS285Colour(TAccessMode& accessMode)
    ...
    template<class TAccessMode,class TPanelTraits>
    constexpr inline uint16_t LDS285Colour<COLOURS_16BIT,TAccessMode,TPanelTraits>::getInterfacePixelFormat() const {
      return 0x55;
    }
    ...
    template<class TAccessMode,class TPanelTraits>
    inline void LDS285Colour<COLOURS_16BIT,TAccessMode,TPanelTraits>::rawTransfer(const void *buffer,uint32_t numPixels) const {
