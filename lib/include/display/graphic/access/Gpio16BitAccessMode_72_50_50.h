...
namespace stm32plus {
  namespace display {
    ...
    class Gpio16BitAccessMode<TPinPackage,TColourDepth,72,50,50> {
    ...
    template<class TPinPackage,ColourDepth TColourDepth>
    inline Gpio16BitAccessMode<TPinPackage,TColourDepth,72,50,50>::Gpio16BitAccessMode() {
...
#error Unsupported MCU
    ...
    template<class TPinPackage,ColourDepth TColourDepth>
    inline void Gpio16BitAccessMode<TPinPackage,TColourDepth,72,50,50>::reset() const {
    ...
    template<class TPinPackage,ColourDepth TColourDepth>
    inline void Gpio16BitAccessMode<TPinPackage,TColourDepth,72,50,50>::writeCommand(uint16_t command) const {
    ...
    template<class TPinPackage,ColourDepth TColourDepth>
    inline void Gpio16BitAccessMode<TPinPackage,TColourDepth,72,50,50>::writeCommand(uint16_t command,uint16_t parameter) const {
    ...
    template<class TPinPackage,ColourDepth TColourDepth>
    inline void Gpio16BitAccessMode<TPinPackage,TColourDepth,72,50,50>::writeDataAgain(uint16_t value) const {
      writeData(value);
    }
  ...
  template<class TPinPackage,ColourDepth TColourDepth>
  inline void Gpio16BitAccessMode<TPinPackage,TColourDepth,72,50,50>::writeMultiData(uint32_t howMuch,uint16_t value) const {
    while(howMuch--)
      writeData(value);
  }
    ...
    template<class TPinPackage,ColourDepth TColourDepth>
    inline void Gpio16BitAccessMode<TPinPackage,TColourDepth,72,50,50>::rawTransfer(const void *buffer,uint32_t numWords) const {
