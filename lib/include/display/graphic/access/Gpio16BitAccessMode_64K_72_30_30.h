...
namespace stm32plus {
  namespace display {
    ...
    /**
     * Specialisation for 72Mhz HCLK, 64K colour mode, 30ns low and 30ns high write cycle periods.
     * The 13.8ns HCLK means that we actually achieve 41.4ns (+/- clock accuracy)
     */

    template<class TPinPackage>
    class Gpio16BitAccessMode<TPinPackage,COLOURS_16BIT,72,30,30> {
    ...
    template<class TPinPackage>
    inline Gpio16BitAccessMode<TPinPackage,COLOURS_16BIT,72,30,30>::Gpio16BitAccessMode() {
...
#error Unsupported MCU
    ...
    template<class TPinPackage>
    inline void Gpio16BitAccessMode<TPinPackage,COLOURS_16BIT,72,30,30>::reset() const {
    ...
    template<class TPinPackage>
    inline void Gpio16BitAccessMode<TPinPackage,COLOURS_16BIT,72,30,30>::writeCommand(uint16_t command) const {

      __asm volatile(
        " str  %[value], [%[data]]          \n\t"     // port <= value
        " str  %[rs],    [%[creset], #0]    \n\t"     // [rs] = 0
        " str  %[wr],    [%[creset], #0]    \n\t"     // [wr] = 0
        " mov  r0,       r0                 \n\t"     // burn 1 cycle so we meet the timing requirements
        " str  %[wr],    [%[cset], #0]      \n\t"     // [wr] = 1
    ...
    template<class TPinPackage>
    inline void Gpio16BitAccessMode<TPinPackage,COLOURS_16BIT,72,30,30>::writeCommand(uint16_t command,uint16_t parameter) const {
    ...
    template<class TPinPackage>
    inline void Gpio16BitAccessMode<TPinPackage,COLOURS_16BIT,72,30,30>::writeData(uint16_t value) const {
    ...
    template<class TPinPackage>
    inline void Gpio16BitAccessMode<TPinPackage,COLOURS_16BIT,72,30,30>::writeDataAgain(uint16_t /* value */) const {
  ...
  template<class TPinPackage>
  inline void Gpio16BitAccessMode<TPinPackage,COLOURS_16BIT,72,30,30>::writeMultiData(uint32_t howMuch,uint16_t value) const {
    ...
    template<class TPinPackage>
    inline void Gpio16BitAccessMode<TPinPackage,COLOURS_16BIT,72,30,30>::rawTransfer(const void *buffer,uint32_t numWords) const {
