...
namespace stm32plus {
  ...
  class Dma1Channel7Stream5 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel7Stream5()
        : Dma(DMA1_Stream5,DMA_Channel_7,DMA_FLAG_TCIF5,DMA_FLAG_HTIF5,DMA_FLAG_TEIF5),
  ...
  template<class... Features> using Dac1DmaChannel=Dma1Channel7Stream5<Features...>;
}
