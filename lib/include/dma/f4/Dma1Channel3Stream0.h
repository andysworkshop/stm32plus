...
namespace stm32plus {
  ...
  class Dma1Channel3Stream0 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel3Stream0()
        : Dma(DMA1_Stream0,DMA_Channel_3,DMA_FLAG_TCIF0,DMA_FLAG_HTIF0,DMA_FLAG_TEIF0),
  ...
  template<class... Features> using I2S3ExtRxDmaChannel=Dma1Channel3Stream0<Features...>;
}
