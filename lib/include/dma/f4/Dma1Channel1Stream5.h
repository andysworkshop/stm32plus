...
namespace stm32plus {
  ...
  class Dma1Channel1Stream5 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel1Stream5()
        : Dma(DMA1_Stream5,DMA_Channel_1,DMA_FLAG_TCIF5,DMA_FLAG_HTIF5,DMA_FLAG_TEIF5),
  ...
  template<class... Features> using I2C1RxStream5DmaChannel=Dma1Channel1Stream5<Features...>;
}
