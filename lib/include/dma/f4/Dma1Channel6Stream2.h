...
namespace stm32plus {
  ...
  class Dma1Channel6Stream2 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel6Stream2()
        : Dma(DMA1_Stream2,DMA_Channel_6,DMA_FLAG_TCIF2,DMA_FLAG_HTIF2,DMA_FLAG_TEIF2),
  ...
  template<class... Features> using Timer5Channel1DmaChannel=Dma1Channel6Stream2<Features...>;
}
