...
namespace stm32plus {
  ...
  class Dma2Channel7Stream1 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel7Stream1()
        : Dma(DMA2_Stream1,DMA_Channel_7,DMA_FLAG_TCIF1,DMA_FLAG_HTIF1,DMA_FLAG_TEIF1),
  ...
  template<class... Features> using Timer8UpdateDmaChannel=Dma2Channel7Stream1<Features...>;
}
