...
namespace stm32plus {
  ...
  class Dma2Channel2Stream5 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel2Stream5()
        : Dma(DMA2_Stream5,DMA_Channel_2,DMA_FLAG_TCIF5,DMA_FLAG_HTIF5,DMA_FLAG_TEIF5),
  ...
  template<class... Features> using CrypOutDmaChannel=Dma2Channel2Stream5<Features...>;
}
