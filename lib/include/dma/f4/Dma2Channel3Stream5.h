...
namespace stm32plus {
  ...
  class Dma2Channel3Stream5 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel3Stream5()
        : Dma(DMA2_Stream5,DMA_Channel_3,DMA_FLAG_TCIF5,DMA_FLAG_HTIF5,DMA_FLAG_TEIF5),
  ...
  template<class... Features> using Spi1TxStream5DmaChannel=Dma2Channel3Stream5<Features...>;
}
