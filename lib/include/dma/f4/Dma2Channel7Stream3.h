...
namespace stm32plus {
  ...
  class Dma2Channel7Stream3 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel7Stream3()
        : Dma(DMA2_Stream3,DMA_Channel_7,DMA_FLAG_TCIF3,DMA_FLAG_HTIF3,DMA_FLAG_TEIF3),
  ...
  template<class... Features> using Timer8Channel2Stream3DmaChannel=Dma2Channel7Stream3<Features...>;
}
