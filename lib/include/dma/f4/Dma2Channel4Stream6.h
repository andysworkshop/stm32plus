...
namespace stm32plus {
  ...
  class Dma2Channel4Stream6 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel4Stream6()
        : Dma(DMA2_Stream6,DMA_Channel_4,DMA_FLAG_TCIF6,DMA_FLAG_HTIF6,DMA_FLAG_TEIF6),
  ...
  template<class... Features> using SdioStream6DmaChannel=Dma2Channel4Stream6<Features...>;
}
