...
namespace stm32plus {
  ...
  class Dma2Channel1Stream2 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel1Stream2()
        : Dma(DMA2_Stream2,DMA_Channel_1,DMA_FLAG_TCIF2,DMA_FLAG_HTIF2,DMA_FLAG_TEIF2),
  ...
  template<class... Features> using Adc2DmaChannel=Dma2Channel1Stream2<Features...>;
}
