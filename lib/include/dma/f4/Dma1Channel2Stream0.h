...
namespace stm32plus {
  ...
  class Dma1Channel2Stream0 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel2Stream0()
        : Dma(DMA1_Stream0,DMA_Channel_2,DMA_FLAG_TCIF0,DMA_FLAG_HTIF0,DMA_FLAG_TEIF0),
  ...
  template<class... Features> using Timer4Channel1DmaChannel=Dma1Channel2Stream0<Features...>;
}
