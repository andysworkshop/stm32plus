...
namespace stm32plus {
  ...
  class Dma1Channel0Stream2 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel0Stream2()
        : Dma(DMA1_Stream2,DMA_Channel_0,DMA_FLAG_TCIF2,DMA_FLAG_HTIF2,DMA_FLAG_TEIF2),
  ...
  template<class... Features> using Spi3RxStream2DmaChannel=Dma1Channel0Stream2<Features...>;
}
