...
namespace stm32plus {
  ...
  class Dma2Channel6Stream1 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel6Stream1()
        : Dma(DMA2_Stream1,DMA_Channel_6,DMA_FLAG_TCIF1,DMA_FLAG_HTIF1,DMA_FLAG_TEIF1),
  ...
  template<class... Features> using Timer1Channel1DmaChannel=Dma2Channel6Stream1<Features...>;
}
