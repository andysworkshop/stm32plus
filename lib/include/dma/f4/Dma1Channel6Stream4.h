...
namespace stm32plus {
  ...
  class Dma1Channel6Stream4 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel6Stream4()
        : Dma(DMA1_Stream4,DMA_Channel_6,DMA_FLAG_TCIF4,DMA_FLAG_HTIF4,DMA_FLAG_TEIF4),
  ...
  template<class... Features> using Timer5Channel2DmaChannel=Dma1Channel6Stream4<Features...>;
}
