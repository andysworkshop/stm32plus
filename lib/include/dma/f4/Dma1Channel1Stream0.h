...
namespace stm32plus {
  ...
  class Dma1Channel1Stream0 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel1Stream0()
        : Dma(DMA1_Stream0,DMA_Channel_1,DMA_FLAG_TCIF0,DMA_FLAG_HTIF0,DMA_FLAG_TEIF0),
  ...
  template<class... Features> using I2C1RxDmaChannel=Dma1Channel1Stream0<Features...>;
}
