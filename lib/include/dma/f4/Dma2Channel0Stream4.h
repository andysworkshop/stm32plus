...
namespace stm32plus {
  ...
  class Dma2Channel0Stream4 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel0Stream4()
        : Dma(DMA2_Stream4,DMA_Channel_0,DMA_FLAG_TCIF4,DMA_FLAG_HTIF4,DMA_FLAG_TEIF4),
  ...
  template<class... Features> using Adc1Stream4DmaChannel=Dma2Channel0Stream4<Features...>;
}
