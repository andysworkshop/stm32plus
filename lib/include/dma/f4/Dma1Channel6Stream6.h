...
namespace stm32plus {
  ...
  class Dma1Channel6Stream6 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel6Stream6()
        : Dma(DMA1_Stream6,DMA_Channel_6,DMA_FLAG_TCIF6,DMA_FLAG_HTIF6,DMA_FLAG_TEIF6),
  ...
  template<class... Features> using Timer5UpdateStream6DmaChannel=Dma1Channel6Stream6<Features...>;
}
