...
namespace stm32plus {
  ...
  class Dma1Channel4Stream0 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel4Stream0()
        : Dma(DMA1_Stream0,DMA_Channel_4,DMA_FLAG_TCIF0,DMA_FLAG_HTIF0,DMA_FLAG_TEIF0),
  ...
  template<class... Features> using Uart5RxDmaChannel=Dma1Channel4Stream0<Features...>;
}
