...
namespace stm32plus {
  ...
  class Dma2Channel2Stream1 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel2Stream1()
        : Dma(DMA2_Stream1,DMA_Channel_2,DMA_FLAG_TCIF1,DMA_FLAG_HTIF1,DMA_FLAG_TEIF1),
  ...
  template<class... Features> using Adc3Stream1DmaChannel=Dma2Channel2Stream1<Features...>;
}
