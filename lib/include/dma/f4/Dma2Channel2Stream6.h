...
namespace stm32plus {
  ...
  class Dma2Channel2Stream6 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel2Stream6()
        : Dma(DMA2_Stream6,DMA_Channel_2,DMA_FLAG_TCIF6,DMA_FLAG_HTIF6,DMA_FLAG_TEIF6),
  ...
  template<class... Features> using CrypInDmaChannel=Dma2Channel2Stream6<Features...>;
}
