...
namespace stm32plus {
  ...
  class Dma1Channel1Stream4 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel1Stream4()
        : Dma(DMA1_Stream4,DMA_Channel_1,DMA_FLAG_TCIF4,DMA_FLAG_HTIF4,DMA_FLAG_TEIF4),
  ...
  template<class... Features> using Timer7UpdateStream4DmaChannel=Dma1Channel1Stream4<Features...>;
}
