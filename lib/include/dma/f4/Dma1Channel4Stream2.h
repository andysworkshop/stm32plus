...
namespace stm32plus {
  ...
  class Dma1Channel4Stream2 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel4Stream2()
        : Dma(DMA1_Stream2,DMA_Channel_4,DMA_FLAG_TCIF2,DMA_FLAG_HTIF2,DMA_FLAG_TEIF2),
  ...
  template<class... Features> using Uart4RxDmaChannel=Dma1Channel4Stream2<Features...>;
}
