...
namespace stm32plus {
  ...
  class Dma2Channel4Stream7 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel4Stream7()
        : Dma(DMA2_Stream7,DMA_Channel_4,DMA_FLAG_TCIF7,DMA_FLAG_HTIF7,DMA_FLAG_TEIF7),
  ...
  template<class... Features> using Usart1TxDmaChannel=Dma2Channel4Stream7<Features...>;
}
