...
namespace stm32plus {
  ...
  class Dma1Channel4Stream6 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel4Stream6()
        : Dma(DMA1_Stream6,DMA_Channel_4,DMA_FLAG_TCIF6,DMA_FLAG_HTIF6,DMA_FLAG_TEIF6),
  ...
  template<class... Features> using Usart2TxDmaChannel=Dma1Channel4Stream6<Features...>;
}
