...
namespace stm32plus {
  ...
  class Dma1Channel1Stream2 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel1Stream2()
        : Dma(DMA1_Stream2,DMA_Channel_1,DMA_FLAG_TCIF2,DMA_FLAG_HTIF2,DMA_FLAG_TEIF2),
  ...
  template<class... Features> using Timer7UpdateDmaChannel=Dma1Channel1Stream2<Features...>;
}
