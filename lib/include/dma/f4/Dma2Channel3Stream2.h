...
namespace stm32plus {
  ...
  class Dma2Channel3Stream2 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel3Stream2()
        : Dma(DMA2_Stream2,DMA_Channel_3,DMA_FLAG_TCIF2,DMA_FLAG_HTIF2,DMA_FLAG_TEIF2),
  ...
  template<class... Features> using Spi1RxStream2DmaChannel=Dma2Channel3Stream2<Features...>;
}
