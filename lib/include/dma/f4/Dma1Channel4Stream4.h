...
namespace stm32plus {
  ...
  class Dma1Channel4Stream4 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel4Stream4()
        : Dma(DMA1_Stream4,DMA_Channel_4,DMA_FLAG_TCIF4,DMA_FLAG_HTIF4,DMA_FLAG_TEIF4),
  ...
  template<class... Features> using Uart4TxDmaChannel=Dma1Channel4Stream4<Features...>;
}
