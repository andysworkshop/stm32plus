...
namespace stm32plus {
  ...
  class Dma1Channel3Stream2 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel3Stream2()
        : Dma(DMA1_Stream2,DMA_Channel_3,DMA_FLAG_TCIF2,DMA_FLAG_HTIF2,DMA_FLAG_TEIF2),
  ...
  template<class... Features> using I2C3RxDmaChannel=Dma1Channel3Stream2<Features...>;
}
