...
namespace stm32plus {
  ...
  class Dma1Channel7Stream6 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel7Stream6()
        : Dma(DMA1_Stream6,DMA_Channel_7,DMA_FLAG_TCIF6,DMA_FLAG_HTIF6,DMA_FLAG_TEIF6),
  ...
  template<class... Features> using Dac2DmaChannel=Dma1Channel7Stream6<Features...>;
}
