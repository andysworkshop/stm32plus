...
namespace stm32plus {
  ...
  class Dma1Channel3Stream3 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel3Stream3()
        : Dma(DMA1_Stream3,DMA_Channel_3,DMA_FLAG_TCIF3,DMA_FLAG_HTIF3,DMA_FLAG_TEIF3),
  ...
  template<class... Features> using I2S2ExtRxStream3DmaChannel=Dma1Channel3Stream3<Features...>;
}
