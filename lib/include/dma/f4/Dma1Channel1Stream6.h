...
namespace stm32plus {
  ...
  class Dma1Channel1Stream6 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel1Stream6()
        : Dma(DMA1_Stream6,DMA_Channel_1,DMA_FLAG_TCIF6,DMA_FLAG_HTIF6,DMA_FLAG_TEIF6),
  ...
  template<class... Features> using I2C1TxDmaChannel=Dma1Channel1Stream6<Features...>;
}
