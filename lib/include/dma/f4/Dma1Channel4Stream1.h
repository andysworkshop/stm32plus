...
namespace stm32plus {
  ...
  class Dma1Channel4Stream1 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel4Stream1()
        : Dma(DMA1_Stream1,DMA_Channel_4,DMA_FLAG_TCIF1,DMA_FLAG_HTIF1,DMA_FLAG_TEIF1),
  ...
  template<class... Features> using Usart3RxDmaChannel=Dma1Channel4Stream1<Features...>;
}
