...
namespace stm32plus {
  ...
  class Dma1Channel7Stream7 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel7Stream7()
        : Dma(DMA1_Stream7,DMA_Channel_7,DMA_FLAG_TCIF7,DMA_FLAG_HTIF7,DMA_FLAG_TEIF7),
  ...
  template<class... Features> using I2C2TxDmaChannel=Dma1Channel7Stream7<Features...>;
}
