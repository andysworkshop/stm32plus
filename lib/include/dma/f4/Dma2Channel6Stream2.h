...
namespace stm32plus {
  ...
  class Dma2Channel6Stream2 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel6Stream2()
        : Dma(DMA2_Stream2,DMA_Channel_6,DMA_FLAG_TCIF2,DMA_FLAG_HTIF2,DMA_FLAG_TEIF2),
  ...
  template<class... Features> using Timer1Channel2DmaChannel=Dma2Channel6Stream2<Features...>;
}
