...
namespace stm32plus {
  ...
  class Dma1Channel0Stream5 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel0Stream5()
        : Dma(DMA1_Stream5,DMA_Channel_0,DMA_FLAG_TCIF5,DMA_FLAG_HTIF5,DMA_FLAG_TEIF5),
  ...
  template<class... Features> using Spi3TxDmaChannel=Dma1Channel0Stream5<Features...>;
}
