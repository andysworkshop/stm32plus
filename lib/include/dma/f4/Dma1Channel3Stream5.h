...
namespace stm32plus {
  ...
  class Dma1Channel3Stream5 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel3Stream5()
        : Dma(DMA1_Stream5,DMA_Channel_3,DMA_FLAG_TCIF5,DMA_FLAG_HTIF5,DMA_FLAG_TEIF5),
  ...
  template<class... Features> using Timer2Channel1DmaChannel=Dma1Channel3Stream5<Features...>;
}
