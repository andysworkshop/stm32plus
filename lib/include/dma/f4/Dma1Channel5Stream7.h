...
namespace stm32plus {
  ...
  class Dma1Channel5Stream7 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel5Stream7()
        : Dma(DMA1_Stream7,DMA_Channel_5,DMA_FLAG_TCIF7,DMA_FLAG_HTIF7,DMA_FLAG_TEIF7),
  ...
  template<class... Features> using Timer3Channel3DmaChannel=Dma1Channel5Stream7<Features...>;
}
