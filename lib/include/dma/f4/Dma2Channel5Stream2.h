...
namespace stm32plus {
  ...
  class Dma2Channel5Stream2 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel5Stream2()
        : Dma(DMA2_Stream2,DMA_Channel_5,DMA_FLAG_TCIF2,DMA_FLAG_HTIF2,DMA_FLAG_TEIF2),
  ...
  template<class... Features> using Usart6RxStream2DmaChannel=Dma2Channel5Stream2<Features...>;
}
