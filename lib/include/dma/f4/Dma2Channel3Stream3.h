...
namespace stm32plus {
  ...
  class Dma2Channel3Stream3 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel3Stream3()
        : Dma(DMA2_Stream3,DMA_Channel_3,DMA_FLAG_TCIF3,DMA_FLAG_HTIF3,DMA_FLAG_TEIF3),
  ...
  template<class... Features> using Spi1TxDmaChannel=Dma2Channel3Stream3<Features...>;
}
