...
namespace stm32plus {
  ...
  class Dma1Channel0Stream3 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel0Stream3()
        : Dma(DMA1_Stream3,DMA_Channel_0,DMA_FLAG_TCIF3,DMA_FLAG_HTIF3,DMA_FLAG_TEIF3),
  ...
  template<class... Features> using Spi2RxDmaChannel=Dma1Channel0Stream3<Features...>;
}
