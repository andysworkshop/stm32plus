...
namespace stm32plus {
  ...
  class Dma1Channel0Stream7 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel0Stream7()
        : Dma(DMA1_Stream7,DMA_Channel_0,DMA_FLAG_TCIF7,DMA_FLAG_HTIF7,DMA_FLAG_TEIF7),
  ...
  template<class... Features> using Spi3TxStream7DmaChannel=Dma1Channel0Stream7<Features...>;
}
