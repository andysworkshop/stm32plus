...
namespace stm32plus {
  ...
  class Dma2Channel1Stream7 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel1Stream7()
        : Dma(DMA2_Stream7,DMA_Channel_1,DMA_FLAG_TCIF7,DMA_FLAG_HTIF7,DMA_FLAG_TEIF7),
  ...
  template<class... Features> using DcmiStream7DmaChannel=Dma2Channel1Stream7<Features...>;
}
