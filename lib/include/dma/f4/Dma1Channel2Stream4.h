...
namespace stm32plus {
  ...
  class Dma1Channel2Stream4 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel2Stream4()
        : Dma(DMA1_Stream4,DMA_Channel_2,DMA_FLAG_TCIF4,DMA_FLAG_HTIF4,DMA_FLAG_TEIF4),
  ...
  template<class... Features> using I2S2ExtTxDmaChannel=Dma1Channel2Stream4<Features...>;
}
