...
namespace stm32plus {
  ...
  class Dma1Channel7Stream2 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel7Stream2()
        : Dma(DMA1_Stream2,DMA_Channel_7,DMA_FLAG_TCIF2,DMA_FLAG_HTIF2,DMA_FLAG_TEIF2),
  ...
  template<class... Features> using I2C2RxDmaChannel=Dma1Channel7Stream2<Features...>;
}
