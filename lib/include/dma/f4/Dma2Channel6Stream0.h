...
namespace stm32plus {
  ...
  class Dma2Channel6Stream0 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel6Stream0()
        : Dma(DMA2_Stream0,DMA_Channel_6,DMA_FLAG_TCIF0,DMA_FLAG_HTIF0,DMA_FLAG_TEIF0),
  ...
  template<class... Features> using Timer1TriggerDmaChannel=Dma2Channel6Stream0<Features...>;
}
