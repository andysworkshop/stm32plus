...
namespace stm32plus {
  ...
  class Dma2Channel3Stream0 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel3Stream0()
        : Dma(DMA2_Stream0,DMA_Channel_3,DMA_FLAG_TCIF0,DMA_FLAG_HTIF0,DMA_FLAG_TEIF0),
  ...
  template<class... Features> using Spi1RxDmaChannel=Dma2Channel3Stream0<Features...>;
}
