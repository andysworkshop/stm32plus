...
namespace stm32plus {
  ...
  class Dma2Channel6Stream6 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel6Stream6()
        : Dma(DMA2_Stream6,DMA_Channel_6,DMA_FLAG_TCIF6,DMA_FLAG_HTIF6,DMA_FLAG_TEIF6),
  ...
  template<class... Features> using Timer1Channel3Stream6DmaChannel=Dma2Channel6Stream6<Features...>;
}
