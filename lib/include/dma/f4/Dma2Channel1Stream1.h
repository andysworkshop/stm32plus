...
namespace stm32plus {
  ...
  class Dma2Channel1Stream1 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel1Stream1()
        : Dma(DMA2_Stream1,DMA_Channel_1,DMA_FLAG_TCIF1,DMA_FLAG_HTIF1,DMA_FLAG_TEIF1),
  ...
  template<class... Features> using DcmiDmaChannel=Dma2Channel1Stream1<Features...>;
}
