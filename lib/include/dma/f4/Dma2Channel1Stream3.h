...
namespace stm32plus {
  ...
  class Dma2Channel1Stream3 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel1Stream3()
        : Dma(DMA2_Stream3,DMA_Channel_1,DMA_FLAG_TCIF3,DMA_FLAG_HTIF3,DMA_FLAG_TEIF3),
  ...
  template<class... Features> using Adc2Stream3DmaChannel=Dma2Channel1Stream3<Features...>;
}
