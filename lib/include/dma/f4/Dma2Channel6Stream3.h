...
namespace stm32plus {
  ...
  class Dma2Channel6Stream3 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel6Stream3()
        : Dma(DMA2_Stream3,DMA_Channel_6,DMA_FLAG_TCIF3,DMA_FLAG_HTIF3,DMA_FLAG_TEIF3),
  ...
  template<class... Features> using Timer1Channel1Stream3DmaChannel=Dma2Channel6Stream3<Features...>;
}
