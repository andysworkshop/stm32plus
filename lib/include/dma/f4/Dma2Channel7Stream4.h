...
namespace stm32plus {
  ...
  class Dma2Channel7Stream4 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel7Stream4()
        : Dma(DMA2_Stream4,DMA_Channel_7,DMA_FLAG_TCIF4,DMA_FLAG_HTIF4,DMA_FLAG_TEIF4),
  ...
  template<class... Features> using Timer8Channel3Stream4DmaChannel=Dma2Channel7Stream4<Features...>;
}
