...
namespace stm32plus {
  ...
  class Dma1Channel5Stream5 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel5Stream5()
        : Dma(DMA1_Stream5,DMA_Channel_5,DMA_FLAG_TCIF5,DMA_FLAG_HTIF5,DMA_FLAG_TEIF5),
  ...
  template<class... Features> using Timer3Channel2DmaChannel=Dma1Channel5Stream5<Features...>;
}
