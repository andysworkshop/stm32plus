...
namespace stm32plus {
  ...
  class Dma2Channel0Stream0 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma2Channel0Stream0()
        : Dma(DMA2_Stream0,DMA_Channel_0,DMA_FLAG_TCIF0,DMA_FLAG_HTIF0,DMA_FLAG_TEIF0),
  ...
  template<class... Features> using Adc1DmaChannel=Dma2Channel0Stream0<Features...>;
}
