...
namespace stm32plus {
  ...
  class Dma1Channel0Stream4 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel0Stream4()
        : Dma(DMA1_Stream4,DMA_Channel_0,DMA_FLAG_TCIF4,DMA_FLAG_HTIF4,DMA_FLAG_TEIF4),
  ...
  template<class... Features> using Spi2TxDmaChannel=Dma1Channel0Stream4<Features...>;
}
