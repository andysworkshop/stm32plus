...
namespace stm32plus {
  ...
  class Dma1Channel3Stream4 : public Dma,
                              public Features... {
    ...
    public:
      ...
      Dma1Channel3Stream4()
        : Dma(DMA1_Stream4,DMA_Channel_3,DMA_FLAG_TCIF4,DMA_FLAG_HTIF4,DMA_FLAG_TEIF4),
  ...
  template<class... Features> using I2C3TxDmaChannel=Dma1Channel3Stream4<Features...>;
}
