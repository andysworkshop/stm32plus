...
namespace stm32plus {
   ...
   * @tparam TChannelNumber The number of the DMA channel (1..5)
   */
  ...
  class DmaInterruptFeatureEnabler {
    ...
    public:
      static void enable(uint8_t priority,uint8_t subPriority=0);     // no subpriority. here for compatibility
  };
  ...
  template<uint8_t TChannelNumber>
  DmaEventSource *DmaInterruptFeature<TChannelNumber>::_dmaInstance;
  ...
  template<uint8_t TChannelNumber>
  inline DmaInterruptFeature<TChannelNumber>::DmaInterruptFeature(Dma& dma)
    : DmaFeatureBase(dma) {
    _nvicPriority=0;
    _interruptMask=0;
    _dmaInstance=this;
  ...
  template<uint8_t TChannelNumber>
  inline DmaInterruptFeature<TChannelNumber>::~DmaInterruptFeature() {
    if(_interruptMask!=0)
  ...
  template<uint8_t TChannelNumber>
  inline void DmaInterruptFeature<TChannelNumber>::setNvicPriorities(uint8_t priority,uint8_t /* subPriority */) {
  ...
  template<uint8_t TChannelNumber>
  inline void DmaInterruptFeature<TChannelNumber>::enableInterrupts(uint16_t interruptMask) {

    _interruptMask|=interruptMask;
    DmaInterruptFeatureEnabler<TChannelNumber>::enable(_nvicPriority);
  ...
  template<uint8_t TChannelNumber>
  inline void DmaInterruptFeature<TChannelNumber>::disableInterrupts(uint16_t interruptMask) {
    _interruptMask&=~interruptMask;
  ...
  template<>
  inline void DmaInterruptFeatureEnabler<1>::enable(uint8_t priority,uint8_t /* subPriority */) {
    _forceLinkage=&DMA1_Channel1_IRQHandler;
    Nvic::configureIrq(DMA1_Channel1_IRQn,ENABLE,priority);
  }
  ...
  template<>
  inline void DmaInterruptFeatureEnabler<2>::enable(uint8_t priority,uint8_t /* subPriority */) {
    _forceLinkage=&DMA1_Channel2_3_IRQHandler;
    Nvic::configureIrq(DMA1_Channel2_3_IRQn,ENABLE,priority);
  }
  ...
  template<>
  inline void DmaInterruptFeatureEnabler<3>::enable(uint8_t priority,uint8_t /* subPriority */) {
    _forceLinkage=&DMA1_Channel2_3_IRQHandler;
    Nvic::configureIrq(DMA1_Channel2_3_IRQn,ENABLE,priority);
  }
  ...
  template<>
  inline void DmaInterruptFeatureEnabler<4>::enable(uint8_t priority,uint8_t /* subPriority */) {
    _forceLinkage=&DMA1_Channel4_5_IRQHandler;
    Nvic::configureIrq(DMA1_Channel4_5_IRQn,ENABLE,priority);
  }
  ...
  template<>
  inline void DmaInterruptFeatureEnabler<5>::enable(uint8_t priority,uint8_t /* subPriority */) {
    _forceLinkage=&DMA1_Channel4_5_IRQHandler;
    Nvic::configureIrq(DMA1_Channel4_5_IRQn,ENABLE,priority);
  }
}
