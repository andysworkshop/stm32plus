...
namespace stm32plus {
  ...
  inline UsartDmaReaderFeature<TUsart,TPriority>::UsartDmaReaderFeature(Dma& dma)
    : DmaFeatureBase(dma) {
  ...
  template<class TUsart,uint32_t TPriority>
  inline void UsartDmaReaderFeature<TUsart,TPriority>::beginRead(void *dest,uint32_t count) {
