   ...
   */
    ...
    void __attribute__ ((interrupt("IRQ"))) DMA1_Stream0_IRQHandler() {
      ...
      if(DMA_GetITStatus(DMA1_Stream0,DMA_IT_TCIF0)!=RESET) {
        DmaInterruptFeature<1,0>::_dmaInstance->notifyObservers(ObservableEvent::DMA_TransferComplete,(void *)0x00010000);
        DMA_ClearITPendingBit(DMA1_Stream0,DMA_IT_TCIF0);
      }
      else if(DMA_GetITStatus(DMA1_Stream0,DMA_IT_HTIF0)!=RESET) {
        DmaInterruptFeature<1,0>::_dmaInstance->notifyObservers(ObservableEvent::DMA_HalfTransfer,(void *)0x00010000);
        DMA_ClearITPendingBit(DMA1_Stream0,DMA_IT_HTIF0);
      }
      else if(DMA_GetITStatus(DMA1_Stream0,DMA_IT_TEIF0)!=RESET) {
        DmaInterruptFeature<1,0>::_dmaInstance->notifyObservers(ObservableEvent::DMA_TransferError,(void *)0x00010000);
