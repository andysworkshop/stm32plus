...
namespace stm32plus {
  ...
  /**
   * SDIO feature to handle interrupts. This class is the only
   * Observable in the SDIO feature class suite.
   */

  class SdioInterruptFeature : public Observable,
    ...
    public:
      static Observable *_sdioInstance;
