...
namespace stm32plus {
  ...
  class TimerInterruptFeature : public Observable, public TimerFeatureBase {
    ...
    public:
      static Observable *_timerInstance;
  ...
  template<uint8_t TTimerNumber>
  Observable *TimerInterruptFeature<TTimerNumber>::_timerInstance;
