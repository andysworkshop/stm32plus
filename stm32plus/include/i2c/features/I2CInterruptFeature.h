...
namespace stm32plus {
  ...
  /**
   * I2C feature to handle interrupts. This class is the only
   * Observable in the I2C class suite.
   * @tparam TI2CNumber The number of the I2C peripheral (1..5)
   */

  template<uint8_t TI2CNumber>
  class I2CInterruptFeature : public Observable,
    ...
    public:
      static Observable *_i2cInstance;
  ...
  template<uint8_t TI2CNumber>
  Observable *I2CInterruptFeature<TI2CNumber> ::_i2cInstance;
