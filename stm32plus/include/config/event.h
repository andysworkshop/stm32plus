...
#define DECLARE_EVENT_SIGNATURE(name,sig) typedef wink::slot<sig> name##EventSourceSlot;
#define DECLARE_EVENT_SOURCE(name) wink::signal<name##EventSourceSlot> name##EventSender;
