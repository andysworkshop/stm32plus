...
namespace stm32plus {
	...
	inline SpiDmaWriterFeature<TSpi,TPriority,TFifoMode>::SpiDmaWriterFeature(Dma& dma)
		: DmaFeatureBase(dma) {
	...
	template<class TSpi,uint32_t TPriority,uint32_t TFifoMode>
	inline void SpiDmaWriterFeature<TSpi,TPriority,TFifoMode>::beginWrite(const void *source,uint32_t count) {
