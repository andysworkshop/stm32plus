...
namespace stm32plus {
   ...
   * Observable in the Spi class suite.
   * @tparam TSpiNumber The number of the Spi peripheral (1..5)
   */

  template<uint8_t TSpiNumber>
  class SpiInterruptFeature : public Observable,
    ...
    public:
      static Observable *_spiInstance;
  ...
  template<uint8_t TSpiNumber>
  Observable *SpiInterruptFeature<TSpiNumber> ::_spiInstance;
