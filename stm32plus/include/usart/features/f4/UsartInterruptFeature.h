...
namespace stm32plus {
  ...
  /**
   * DMA feature to handle interrupts. This class is the only
   * Observable in the USART class suite.
   * @tparam TUsartNumber The number of the USART peripheral (1..6)
   */

  template<uint8_t TUsartNumber>
  class UsartInterruptFeature : public Observable,
    ...
    public:
      ...
      static Observable *_usartInstance;
  ...
  template<uint8_t TUsartNumber>
  Observable *UsartInterruptFeature<TUsartNumber> ::_usartInstance;
