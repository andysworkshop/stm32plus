 ...
 * in simultaneous mode. Also add external triggering on EXTI 11.
 */
...
typedef Adc1<
    ...
    AdcExti11RisingTriggerFeature,                  // EXTI11 triggering
    DualAdcRegularSimultaneousDmaMode1Feature<      // regular simultaneous multi mode, DMA mode 1
      Adc2<                                         // the second ADC
        AdcClockPrescalerFeature<2>,                // prescaler of 2
        AdcResolutionFeature<8>,                    // 8 bit resolution
